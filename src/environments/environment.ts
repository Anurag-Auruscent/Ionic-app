...
export const environment = {
  ...
  // keycloakUrl: 'https://11e2-111-125-143-169.ngrok-free.app/realms/angular-oauth/protocol/openid-connect/token',
  ...
  // getAllLibrariesApiUrl: 'https://floppy-crabs-matter.loca.lt/library/get-libraries-with-weblinks',
